...
{
    internal sealed class ReservedAddressBlockConfiguration : BaseEntityTypeConfiguration<ReservedAddressBlock>
    {
        public override void Configure(EntityTypeBuilder<ReservedAddressBlock> builder)
        {
